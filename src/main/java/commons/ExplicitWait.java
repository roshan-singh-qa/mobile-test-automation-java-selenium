...
public class ExplicitWait extends GenericHelper {
    ...
    private WebDriverWait getWait() {
        return getWait(Timeout.explicit, Timeout.poolingInterval);
    }
    ...
    public WebElement forElementToBeVisible(By locator) {
        return forElementToBeVisible(locator, Timeout.explicit, Timeout.poolingInterval);
    }

    public WebElement forElementToBeVisible(By locator, int timeoutInSeconds) {
        return forElementToBeVisible(locator, timeoutInSeconds, Timeout.poolingInterval);
    }

    public WebElement forElementToBeVisible(WebElement webElement) {
        return forElementToBeVisible(webElement, Timeout.explicit, Timeout.poolingInterval);
    }

    public WebElement forElementToBeVisible(WebElement webElement, int timeoutInSeconds) {
        return forElementToBeVisible(webElement, timeoutInSeconds, Timeout.poolingInterval);
    }
    ...
    public WebElement forElementToBeClickable(By element) {
        return forElementToBeClickable(element, Timeout.explicit, Timeout.poolingInterval);
    }
    ...
    public boolean forInvisibilityOfElement(WebElement element) {
        return forInvisibilityOfElement(element, Timeout.explicit, Timeout.poolingInterval);
    }

    public boolean forInvisibilityOfElement(By locator) {
        return forInvisibilityOfElement(locator, Timeout.explicit, Timeout.poolingInterval);
    }
    ...
    public boolean forPage() {
        return forPage(Timeout.page);
    }

    public boolean forPage(int timeoutInSeconds) {
        log.debug("Waiting for the document to load");
        WebDriverWait wait = getWait(timeoutInSeconds, Timeout.poolingInterval);
    ...
    private <V> V waitFor(Function expectedCondition) {
        return waitFor(expectedCondition, Timeout.explicit, Timeout.poolingInterval);
    }
